...
| NZQA 2021 Q3(a)(ii–iii) | Same extract | NHT and harmonic-technique analysis | X/Y/Z note labels | Classify three NHTs and identify two techniques | X appoggiatura, Y accented passing note, Z passing note; descending chromatic inner line and tonic pedal | Explain how the chromatic line creates movement over tonal stability | `nzqa-2021-valentine-techniques` / adapted original retained with displayed bars 1–9 |

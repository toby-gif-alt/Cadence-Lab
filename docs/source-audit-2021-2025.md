...
- `existing exact` means the source task is retained as a page transcription; `adapted original retained` means its useful semantic exercise remains under `original-practice`; `combine` means closely related paper subparts share one structured Cadence Lab item; `defer` means an exact source transcription still needs a later notation pass.
...
Reference metadata records `provider`, `year`, `question`, `part`, `extract`, `creator`, `title`, `bars`, `sourceKind`, source-page location and acknowledgement where those details are available. A retained reference must also declare `transcriptionMode: "exact"`, the printed bar/measure count and a source-derived staff/rhythm signature. Adapted studies identify the paper that informed them but do not count as references.
...
| NZQA 2021 Q2(b) | Extract Five, piano | Piano completion; B♭ major → F major → related region | Melody, first texture and Roman indications | Add bass and two inner parts in style | 8 chord moments in the published model | Sustained idiomatic texture and convincing tonal route | defer; adapted original retained |
| NZQA 2021 Q3(a)(i) | Extract Six, Rodgers and Hart, “My Funny Valentine” | Jazz/rock chord analysis | First chords and vocal/piano score | Identify chord symbols | 9 assessed chords with source spellings | Extended accurate chord sequence | defer; adapted original retained |
| NZQA 2021 Q3(a)(ii–iii) | Same extract | NHT and harmonic-technique analysis | X/Y/Z note labels | Classify three NHTs and identify two techniques | X at bars 22 and 24: auxiliary note; Y at bars 21, 23 and 25: accented passing note; Z at bar 26: appoggiatura; descending chromatic inner line and tonic pedal | Explain how the chromatic line creates movement over tonal stability | Exact source deferred. `nzqa-2021-valentine-techniques` is an adapted original with displayed bars 1–9 and its own examples: X appoggiatura, Y accented passing note, Z passing note. |
...
| Source / part | Extract, creator and title | Task / key context | Learner is given | Learner must… | Schedule/model evidence | Excellence expectation | Existing equivalent / action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| NZQA 2022 Q1(a) | Extract One, J. S. Bach chorale | Roman analysis with pivots/cadences | Opening/closing labels and stated key route | Analyse progression and identify two cadences | 10 assessed chords and two cadences; closing source indication `Vsus4 – V#3` retained exactly | Complete, contextual analysis | `nzqa-2022-bach-c-aminor` / existing; `V`, `V3` and `V#3` share dominant identity where appropriate |
...
| Source / part | Extract, creator and title | Task / key context | Learner is given | Learner must… | Schedule/model evidence | Excellence expectation | Existing equivalent / action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| NZQA 2023 Q1(a) | Extract One, J. S. Bach chorale | Roman analysis; C minor → G minor | First labels and tonal route | Analyse bars 1–4 and pivot | 13 assessed chords with exact minor-key spellings | Complete progression and modulation | defer; adapted original retained |
...
| NZQA 2023 Q2(a) | Extract Four, Francis Poulenc | Harmonic/tonal feature | Score | Identify a compositional device and explain function | Pedal-point response and supported alternatives | Connect device, score location, harmonic function and effect | `nzqa-2023-poulenc-pedal` / adapted original retained; exact two-voice piano transcription deferred |
...
| NZQA 2023 Q2(c) | Extract Six, Francis Poulenc arrangement of “Novelette No. 1 in C minor” | Piano completion; extract in C major | Melody, Roman indications and first texture | Complete bars 21–24 | 7 chord moments | Convincing continuation of texture/cadence | defer; adapted original retained with corrected Poulenc provenance |
...
| NZQA 2024 Q1(b) | Extract Two, J. S. Bach chorale | Modulation; home C major | Exact bars 6–9 and X/Y brackets | Identify key, evidence and relationship | X A minor / relative minor with G♯ and a perfect cadence; Y G major / dominant with F♯ and a perfect cadence | Evidence-linked relationship analysis | `nzqa-2024-bach-key-regions` / existing exact |
...
| NZQA 2024 Q2(a)(i) | Extract Four, Rimsky-Korsakov, “Two Piano Pieces” | Roman analysis; F♯ minor → A major | Opening key, first `i`, and printed bars 1–25 | Analyse bars 2–14 | 13 assessed chords with the published inversions | Secure extended analysis | `nzqa-2024-rimsky-analysis` / existing exact |
| NZQA 2024 Q2(a)(ii) | Extract Four | Integrated tonality, modulation and NHT analysis | Full printed score | Explain the direct move to A major and analyse located non-harmonic notes | A-major move without pivot, pedal support and schedule NHT classifications | Integrated, evidence-rich explanation | `nzqa-2024-rimsky-context` / existing exact |
...
| NZQA 2024 Q3(a)(i) | Extract Six, Feist, “Love is Commercial” | Jazz/rock chord analysis | Opening symbol and score | Analyse bars 19–28 | 11 exact symbols, including E♯dim7 | Extended exact source analysis | `nzqa-2024-commercial-chromatic-bass` / adapted original retained |
| NZQA 2024 Q3(a)(ii) | Same extract | Chromatic bass/harmonic rhythm | Score | Explain device and effect | Frequent harmonic changes and chromatic bass create momentum | Evidence-linked contextual effect | adapted original retained with Q3(a) |
...
| Source / part | Extract, creator and title | Task / key context | Learner is given | Learner must… | Schedule/model evidence | Excellence expectation | Existing equivalent / action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| NZQA 2025 Q1(a) | Extract One, J. S. Bach, “Komm, Heiliger Geist, Herre Gott” | Roman analysis; G major → D major → G major | Bars 5–9 and first three labels I, Vb, IVb | Analyse 12 positions in bars 6–9 including both pivots | 12 assessed chords; exact inversions and pivot spellings | Complete extended analysis and both key transitions | `nzqa-2025-bach-analysis` / existing exact |
| NZQA 2025 Q1(b) | Extract Two, Bach chorale | Modulation; home G major | X/Y/Z brackets | Identify keys, evidence and relationships | X E minor / relative minor; Y D major / dominant; Z A minor / relative minor of subdominant (supertonic minor accepted) | Explain all regions with cadence and leading-note evidence | `nzqa-2025-bach-modulation` / existing exact |
| NZQA 2025 Q1(c)(i) | Extract Three, Bach chorale | SATB/vocal completion; G major | Four indications I, Ib, IV9–8, I and supplied tenor through bar 23 beat 1 | Add bass, soprano and alto; include the bar-22 suspension | First four of 10 harmonic moments; model alto visibly resolves D–C within IV9–8 and bar 23 opens over G in the bass | Stylistic voice leading with required suspension | `nzqa-2025-bach-satb` / existing exact, combined two-stage paper completion |
| NZQA 2025 Q1(c)(ii) | Extract Three | SATB/vocal completion; G major | Six blank choice boxes; allowed I, ii, V, V7, vi; supplied continuation context | Choose/label six harmonies, add bass/alto/tenor and two passing notes through bar 24 beat 3 | Six learner-choice moments; root position or inversions accepted where musically appropriate | Complete coherent phrase with two passing notes and labelled choices | `nzqa-2025-bach-satb` / existing exact, combined two-stage paper completion |
| NZQA 2025 Q2(a) | Extract Four, Franz Schubert, “Adagio and Rondo in E Major”, D. 506 / Op. 145 | Roman analysis; E major → F♯ minor → E major | First I and explicit tonal route | Analyse 12 positions in bars 1–6 including pivots | Exact 12-chord schedule route; alternative pivot placement noted by schedule | Complete progression and contextual pivots | `nzqa-2025-schubert-analysis` / upgraded in place to exact reference |
| NZQA 2025 Q2(b) | Extract Five, same work | Contextual harmonic/tonal feature; E major | Bars 7–8 | Identify feature, cite location, explain function/effect | Chromatic contrary semitone movement decorating dominant/cadential arrival; melodic repetition/imitation/sequence also supported | Evidence-linked analytical point, not feature naming alone | `nzqa-2025-schubert-feature` / upgraded in place to exact reference |
| NZQA 2025 Q2(c) | Extract Six, Schubert rondo | Piano completion; E major | Bars 19–24, melody, Roman indications and opening piano style | Add bass and two inner parts in bars 20–24 | 8 chord moments in model | Fluent continuation of texture and tonal shape | `nzqa-2025-schubert-piano` / upgraded in place to exact reference |
| NZQA 2025 Q3(a) | Extract Seven, Billy Joel, “New York State of Mind” | Jazz/rock chord analysis; C major context | Bar 5 C, bar 13 E7(#9), and vocal/piano score | Identify 10 symbols in bars 6–13 | E7, Am7, Gm(add4), C7, F, A7, Dm7, B♭9, B♭7, C | Exact extended analysis with source spelling | `nzqa-2025-joel-chords` / upgraded in place to exact reference |
| NZQA 2025 Q3(b)(i) | Extract Eight, same song, bridge | Integrated harmonic-rhythm analysis | Full bars 24–42 vocal/piano score | Comment on harmonic rhythm | Changes every one or two bars; 1–1–2 pattern; arrival/weight on G, F, A, G | Multiple evidence-linked observations | `nzqa-2025-joel-context` / upgraded in place to exact reference |
| NZQA 2025 Q3(b)(ii) | Extract Eight | Integrated tonality/harmony; C-major home context | Full bridge score | Explain tonality with specific harmonic features | Movement away from C via dominant–tonic and circle-of-fifths motion, seventh/major-seventh additions and major-to-minor changes | Coherent account using several located examples | `nzqa-2025-joel-context` / exact reference, combined with Q3(b)(i) |
| NZQA 2025 Q3(c) | Extract Nine, Billy Joel | Piano completion; jazz/pop context | Bars 14–22, chord symbols, bass-rhythm cues, opening piano texture and endings | Complete bars 15–22 | 10 assessed chord moments in the published sample realisation | Idiomatic accompaniment that preserves harmonic rhythm and voice leading | `nzqa-2025-joel-piano` / upgraded in place to exact paper reference |

## Learning Ideas practice assessments

Learning Ideas material can be labelled **Practice assessment reference** only when the learner-visible notation is transcribed exactly. The current reduced studies are retained as adapted `original-practice`, never as NZQA or practice-assessment references.
...
| Learning Ideas 2022 Q1(b)(i) | Extract Two; modulation; home A major | Identify three keys, evidence and relationships | B minor / supertonic, D major / subdominant, E major / dominant | Full evidence-linked route | defer; adapted original retained |
| Learning Ideas 2022 Q1(b)(ii) | Extract Two; A♯ function | Explain A♯ in bars 2–3 | Leading note of B minor; third of F♯7; supports perfect cadence and voice leading | Join pitch, local harmony and modulation | defer; adapted original retained with Q1(b) |
...
| Learning Ideas 2022 Q2(a) | Extract Four; integrated Roman/modulation/NHT; D minor | Analyse bars 1–3, keys and NHTs | 8 chords; F relative major, A dominant major; passing, auxiliary and accented-passing labels | Integrate progression, tonal route and note classification | Exact score deferred. The retained Cadence Lab adaptation uses eight mapped Roman boxes, a new D-minor/F-major/A-major melody, and three independently validated NHT examples. |
...
| Learning Ideas 2023 Q3(a) | Extract Six; integrated tonality/harmony; E♭ major | Analyse tonal establishment, tonicisation/modulation and progression | ii–V–I patterns; IV→iv opening ambiguity; B♭7–E♭ cadence; vi; minor ii–V7–i regions; diminished ii | Several precise linked points across the extract | defer; adapted original retained |
...
| Learning Ideas 2024 Q2(a) | Extract Four; two-device contextual analysis | Identify two devices and explain functions | Tonic pedal; melodic sequence; diminution accepted with located effects | Two distinct evidence/function/effect points | defer; adapted original retained |
...
| Learning Ideas 2024 Q3(a) | Extract Seven; integrated jazz tonality/harmony; F major → D minor | Analyse symbols, cadence/tonality and harmonic devices | 14 chords; perfect cadences, minor ii–V–i, G9/G13 secondary dominants | Integrate chord identity with tonal function | defer; adapted original retained |
...
| Learning Ideas 2025 Q2(a)(ii) | Extract Four; integrated tonal/harmonic/NHT analysis | Discuss modulations, relationships and NHTs | A/B/E-minor route; pivot/direct/sequence evidence; passing, accented passing, grace, mordent, suspension and appoggiatura examples | Multiple coherent, located analytical points | Exact score deferred. The retained Cadence Lab adaptation uses an original E-minor/A-major/B-major surface with a transposed melodic sequence and three validated NHTs; its closing harmonic-rhythm change is adaptation-specific. |
...
The bank may grow in stages, but the audit is never reduced to the implemented subset. New reference objects must point back to one row above, use `transcriptionMode: "exact"`, and pass both music-theory validation and independent source-fidelity validation. An adapted, selected, representative, reduced or simplified study must use `original-practice` and cannot contribute to reference totals.

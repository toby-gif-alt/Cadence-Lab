...
const questionBank = [
  ...
  createAdaptedQuestion({
    ...
    analysisFields: [
      { id: "first-region", label: "First local-key region", kind: "text", prompt: "Identify the key, relationship to D minor, and cadence or accidental evidence.", acceptedAnswers: [{ label: "F major is the relative major of D minor; the C7–F perfect cadence establishes the local F-major region." }] },

...
const questionBank = [
  createQuestion({
    ...
    score: measuredScore({
      ...
      measures: [
        { events: [
          { voices: { soprano: "C#5", alto: "A4", tenor: "E3", bass: "A2" }, duration: "q" },
          { voices: { soprano: "C#5", alto: "A4", tenor: "F#3", bass: "F#2" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "E5", alto: "G#4", tenor: "E3", bass: "C#3" }, duration: "q" },
          { voices: { soprano: "F#5", alto: "A4", tenor: "F#3", bass: "D3" }, duration: "q" },
          { voices: { soprano: "E5", alto: "G#4", tenor: "B3", bass: "D3" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "E5", alto: "A4", tenor: "E3", bass: "C#3" }, duration: "q" },
          { voices: { soprano: "F#5", alto: "B4", tenor: "A3", bass: "D#2" }, duration: "q" },
          { voices: { soprano: "E5", alto: "B4", tenor: "G#3", bass: "E3" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "E5", alto: "C#5", tenor: "A3", bass: "A2" }, duration: "q" },
          { voices: { soprano: "C#5", alto: "A4", tenor: "E3", bass: "A2" }, duration: "q" },
          { voices: { soprano: "C#5", alto: "A4", tenor: "F#3", bass: "A2" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "C#5", alto: "G#4", tenor: "E#3", bass: "E#2" }, duration: "h" },
          { voices: { soprano: "B4", alto: "G#4", tenor: "E#3", bass: "C#3" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "C#5", alto: "A4", tenor: "F#3", bass: "F#2" }, duration: "q" },
          { voices: { soprano: "B4", alto: "G#4", tenor: "E3", bass: "D3" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "C#5", alto: "A4", tenor: "E3", bass: "C#3" }, duration: "q" },
          { voices: { soprano: "B4", alto: "A4", tenor: "F#3", bass: "D3" }, duration: "q" },
          { voices: { soprano: "B4", alto: "G#4", tenor: "E3", bass: "E2" }, duration: "q" },
        ] },
        { endBarline: "final", events: [
          { voices: { soprano: "A4", alto: "E4", tenor: "C#3", bass: "A2" }, duration: "hd" },
        ] },
      ],
      harmonicEvents: [
        harmonicBox(1, 1, 0, "A: I", { localKey: "A major", romanNumeral: "I", chordSymbol: "A", questionLabel: "A: I" }),
        harmonicBox(1, 2, 1, "vi", { localKey: "A major", romanNumeral: "vi", chordSymbol: "F♯m", questionLabel: "vi" }),
        harmonicBox(2, 1, 0, "iii", { localKey: "A major", romanNumeral: "iii", chordSymbol: "C♯m", questionLabel: "iii" }),
        harmonicBox(2, 2, 1, "IV", { localKey: "A major", romanNumeral: "IV", chordSymbol: "D", questionLabel: "IV" }),
        harmonicBox(2, 3, 2, "V⁷d", { localKey: "A major", romanNumeral: "V7", chordSymbol: "E7/D", questionLabel: "V⁷d" }),
        harmonicBox(3, 1, 0, "Ib", { localKey: "A major", romanNumeral: "I6", chordSymbol: "A/C♯", questionLabel: "Ib" }),
        harmonicBox(3, 2, 1, "II⁷b", { localKey: "A major", romanNumeral: "II7", chordSymbol: "B7/D♯", questionLabel: "II⁷b" }),
        harmonicBox(3, 3, 2, "V", { localKey: "A major", romanNumeral: "V", chordSymbol: "E", questionLabel: "V" }),
        harmonicBox(4, 1, 0, "I", { localKey: "A major", romanNumeral: "I", chordSymbol: "A", questionLabel: "I" }),
        harmonicBox(4, 2, 1, "I", { localKey: "A major", romanNumeral: "I", chordSymbol: "A" }),
        harmonicBox(4, 3, 2, "A: vib / f♯: ib", { localKey: "F♯ minor", romanNumeral: "i6", chordSymbol: "F♯m/A" }),
        harmonicBox(5, 1, 0, "Vb", { localKey: "F♯ minor", romanNumeral: "V6", chordSymbol: "C♯/E♯" }),
        harmonicBox(5, 3, 1, "V⁷", { localKey: "F♯ minor", romanNumeral: "V7", chordSymbol: "C♯7" }),
        harmonicBox(6, 1, 0, "f♯: I / A: vi", { localKey: "F♯ minor", romanNumeral: "i", chordSymbol: "F♯m" }),
        harmonicBox(6, 2, 1, "A: V⁷d", { localKey: "A major", romanNumeral: "V7", chordSymbol: "E7/D" }),
        harmonicBox(7, 1, 0, "Ib", { localKey: "A major", romanNumeral: "I6", chordSymbol: "A/C♯" }),
        harmonicBox(7, 2, 1, "ii⁷b", { localKey: "A major", romanNumeral: "ii7", chordSymbol: "Bm7/D" }),
        harmonicBox(7, 3, 2, "V", { localKey: "A major", romanNumeral: "V", chordSymbol: "E" }),
        harmonicBox(8, 1, 0, "I", { localKey: "A major", romanNumeral: "I", chordSymbol: "A" }),
      ],
    }),
  ...
  createQuestion({
    ...
    score: measuredScore({
      ...
      measures: [
        { events: [
          { voices: { soprano: "A4", alto: "E4", tenor: "C3", bass: "A2" }, duration: "q" },
          { voices: { soprano: "B4", alto: "G4", tenor: "E3", bass: "E2" }, duration: "8" },
          { voices: { soprano: "C5", alto: "A4", tenor: "F3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "C5", alto: "G4", tenor: "E3", bass: "C3" }, duration: "q" },
          { voices: { soprano: "G4", alto: "E4", tenor: "C3", bass: "E2" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "G4", alto: "E4", tenor: "C3", bass: "G2" }, duration: "q" },
          { voices: { soprano: "G4", alto: "D4", tenor: "B3", bass: "G2" }, duration: "q" },
          { voices: { soprano: "C5", alto: "G4", tenor: "E3", bass: "C3" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "B4", alto: "G4", tenor: "D3", bass: "G2" }, duration: "q" },
          { voices: { soprano: "A4", alto: "F4", tenor: "D3", bass: "D2" }, duration: "q" },
          { voices: { soprano: "A4", alto: "F4", tenor: "D3", bass: "F2" }, duration: "q" },
          { voices: { soprano: "A4", alto: "E4", tenor: "D3", bass: "A2" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "A4", alto: "E4", tenor: "C3", bass: "A2" }, duration: "q" },
          { voices: { soprano: "B4", alto: "G#4", tenor: "D3", bass: "E2" }, duration: "q" },
          { voices: { soprano: "A4", alto: "E4", tenor: "C3", bass: "C3" }, duration: "q" },
          { voices: { soprano: "B4", alto: "A4", tenor: "D3", bass: "E2" }, duration: "q" },
        ] },
        { endBarline: "final", events: [
          { voices: { soprano: "A4", alto: "E4", tenor: "C3", bass: "A2" }, duration: "w" },
        ] },
      ],
      harmonicEvents: [
        harmonicBox(1, 1, 0, "C: vi", { localKey: "C major", romanNumeral: "vi", chordSymbol: "Am", questionLabel: "C: vi" }),
        harmonicBox(1, 2, 1, "iii", { localKey: "C major", romanNumeral: "iii", chordSymbol: "Em" }),
        harmonicBox(1, 2.5, 2, "IV", { localKey: "C major", romanNumeral: "IV", chordSymbol: "F" }),
        harmonicBox(1, 3, 3, "I", { localKey: "C major", romanNumeral: "I", chordSymbol: "C" }),
        harmonicBox(1, 4, 4, "Ib", { localKey: "C major", romanNumeral: "I6", chordSymbol: "C/E" }),
        harmonicBox(2, 1, 0, "Ic", { localKey: "C major", romanNumeral: "I64", chordSymbol: "C/G", questionLabel: "Ic" }),
        harmonicBox(2, 2, 1, "V", { localKey: "C major", romanNumeral: "V", chordSymbol: "G", questionLabel: "V" }),
        harmonicBox(2, 3, 2, "I", { localKey: "C major", romanNumeral: "I", chordSymbol: "C", questionLabel: "I" }),
        harmonicBox(3, 1, 0, "V", { localKey: "C major", romanNumeral: "V", chordSymbol: "G" }),
        harmonicBox(3, 2, 1, "ii", { localKey: "C major", romanNumeral: "ii", chordSymbol: "Dm" }),
        harmonicBox(3, 3, 2, "C: iib / a: ivb", { localKey: "A minor", romanNumeral: "iv6", chordSymbol: "Dm/F" }),
        harmonicBox(3, 4, 3, "i sus⁴", { localKey: "A minor", romanNumeral: "i", chordSymbol: "Asus4" }),
        harmonicBox(4, 1, 0, "i", { localKey: "A minor", romanNumeral: "i", chordSymbol: "Am" }),
        harmonicBox(4, 2, 1, "V♯3", { localKey: "A minor", romanNumeral: "V", chordSymbol: "E7" }),
        { measure: 4, beat: 3, event: 2, analysisBox: false, modelLabel: "(ib)", localKey: "A minor", romanNumeral: "i6", chordSymbol: "Am/C" },
        harmonicBox(4, 4, 3, "V sus⁴–V♯3", { localKey: "A minor", romanNumeral: "V", chordSymbol: "E7sus4", questionLabel: "V sus⁴–V♯3" }),
        harmonicBox(5, 1, 0, "i", { localKey: "A minor", romanNumeral: "i", chordSymbol: "Am", questionLabel: "i" }),
      ],
    }),
    answerHeading: "Reference analysis",
    answer: [
  ...
  createQuestion({
    ...
    score: measuredScore({
      ...
      measures: [
        { events: [
          { voices: { soprano: "G4", alto: "E4", tenor: "G3", bass: "C3" }, duration: "8" },
          { voices: { soprano: "G4", alto: "D4", tenor: "G3", bass: "B2" }, duration: "8" },
          { voices: { soprano: "A4", alto: "E4", tenor: "C4", bass: "A2" }, duration: "q" },
          { voices: { soprano: "G4", alto: "E4", tenor: "B3", bass: "E3" }, duration: "q" },
          { voices: { soprano: "G4", alto: "E4", tenor: "C4", bass: "C3" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "A4", alto: "F4", tenor: "C4", bass: "F2" }, duration: "q" },
          { voices: { soprano: "C5", alto: "F4", tenor: "C4", bass: "A2" }, duration: "q" },
          { voices: { soprano: "G4", alto: "E4", tenor: "C4", bass: "C3" }, duration: "q" },
          { voices: { soprano: "A4", alto: "E4", tenor: "C4", bass: "A2" }, duration: "q" },
        ] },
        { events: [
          { voices: { soprano: "G4", alto: "E4", tenor: "B3", bass: "E3" }, duration: "q" },
          { voices: { soprano: "A4", alto: "F4", tenor: "C4", bass: "F2" }, duration: "q" },
          { voices: { soprano: "G4", alto: "D4", tenor: "B3", bass: "B2" }, duration: "q" },
          { voices: { soprano: "G4", alto: "E4", tenor: "C4", bass: "C3" }, duration: "q" },
        ] },
        { endBarline: "final", events: [
          { voices: { soprano: "A4", alto: "E4", tenor: "C4", bass: "A2" }, duration: "8" },
          { voices: { soprano: "F#4", alto: "D#4", tenor: "A3", bass: "B2" }, duration: "8" },
          { voices: { soprano: "A4", alto: "E4", tenor: "C4", bass: "C3" }, duration: "q" },
          { voices: { soprano: "A4", alto: "F#4", tenor: "C4", bass: "D#3" }, duration: "q" },
          { voices: { soprano: "G4", alto: "E4", tenor: "B3", bass: "E3" }, duration: "q" },
        ] },
      ],
      harmonicEvents: [
        harmonicBox(1, 1, 0, "C: I", { localKey: "C major", romanNumeral: "I", chordSymbol: "C", questionLabel: "C: I" }),
        harmonicBox(1, 1.5, 1, "V", { localKey: "C major", romanNumeral: "V", chordSymbol: "G", questionLabel: "V" }),
        harmonicBox(1, 2, 2, "vi", { localKey: "C major", romanNumeral: "vi", chordSymbol: "Am", questionLabel: "vi" }),
        harmonicBox(1, 3, 3, "iii", { localKey: "C major", romanNumeral: "iii", chordSymbol: "Em", questionLabel: "iii" }),
        harmonicBox(1, 4, 4, "I", { localKey: "C major", romanNumeral: "I", chordSymbol: "C", questionLabel: "I" }),
        harmonicBox(2, 1, 0, "IV", { localKey: "C major", romanNumeral: "IV", chordSymbol: "F" }),
        harmonicBox(2, 2, 1, "IVb", { localKey: "C major", romanNumeral: "IV6", chordSymbol: "F/A" }),
        harmonicBox(2, 3, 2, "I", { localKey: "C major", romanNumeral: "I", chordSymbol: "C" }),
        harmonicBox(2, 4, 3, "vi", { localKey: "C major", romanNumeral: "vi", chordSymbol: "Am" }),
        harmonicBox(3, 1, 0, "iii", { localKey: "C major", romanNumeral: "iii", chordSymbol: "Em" }),
        harmonicBox(3, 2, 1, "IV", { localKey: "C major", romanNumeral: "IV", chordSymbol: "F" }),
        harmonicBox(3, 3, 2, "Vb", { localKey: "C major", romanNumeral: "V6", chordSymbol: "G/B" }),
        harmonicBox(3, 4, 3, "I", { localKey: "C major", romanNumeral: "I", chordSymbol: "C" }),
        harmonicBox(4, 1, 0, "C: vi / e: iv", { localKey: "E minor", romanNumeral: "iv", chordSymbol: "Am" }),
        harmonicBox(4, 1.5, 1, "V⁷", { localKey: "E minor", romanNumeral: "V7", chordSymbol: "B7" }),
        harmonicBox(4, 2, 2, "ivb", { localKey: "E minor", romanNumeral: "iv6", chordSymbol: "Am/C" }),
        harmonicBox(4, 3, 3, "♯vii°⁷", { localKey: "E minor", romanNumeral: "vii7", chordSymbol: "D♯dim7" }),
        harmonicBox(4, 4, 4, "i", { localKey: "E minor", romanNumeral: "i", chordSymbol: "Em" }),
      ],
    }),
  ...
  createQuestion({
    ...
    score: measuredScore({
      ...
      brackets: [
        { start: 5, end: 10, label: "X" },
        { start: 10, end: 15, label: "Y" },
        { start: 24, end: 26, label: "Z" },
      ],
      measures: [
        { events: [
          { voices: { soprano: "G4", alto: "D4", tenor: "Bb3", bass: "G2" }, duration: "q" },
          { voices: { soprano: "A4", alto: "Eb4", tenor: "C3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "Bb4", alto: "D4", tenor: "Bb3", bass: "G2" }, duration: "8" },
          { voices: { soprano: "D5", alto: "F4", tenor: "Bb3", bass: "Bb2" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "Eb5", alto: "G4", tenor: "Bb3", bass: "Eb3" }, duration: "q" },
          { voices: { soprano: "D5", alto: "F4", tenor: "Bb3", bass: "D3" }, duration: "8" },
          { voices: { soprano: "C5", alto: "Eb4", tenor: "G3", bass: "C3" }, duration: "8" },
          { voices: { soprano: "Bb4", alto: "G4", tenor: "Eb3", bass: "Eb2" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "D5", alto: "F4", tenor: "Bb3", bass: "Bb2" }, duration: "q" },
          { voices: { soprano: "C5", alto: "G4", tenor: "Eb3", bass: "C3" }, duration: "8" },
          { voices: { soprano: "B4", alto: "G4", tenor: "D3", bass: "G2" }, duration: "8" },
          { voices: { soprano: "C5", alto: "G4", tenor: "Eb3", bass: "C3" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "Eb5", alto: "G4", tenor: "C3", bass: "C2" }, duration: "q" },
          { voices: { soprano: "D5", alto: "F4", tenor: "Bb3", bass: "D3" }, duration: "8" },
          { voices: { soprano: "C5", alto: "Eb4", tenor: "G3", bass: "C3" }, duration: "8" },
          { voices: { soprano: "Bb4", alto: "F4", tenor: "D3", bass: "Bb2" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "Bb4", alto: "G4", tenor: "Eb3", bass: "Eb2" }, duration: "q" },
          { voices: { soprano: "C5", alto: "A4", tenor: "F3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "D5", alto: "Bb4", tenor: "F3", bass: "Bb2" }, duration: "8" },
          { voices: { soprano: "C5", alto: "A4", tenor: "F3", bass: "F2" }, duration: "h" },
        ] },
        { events: [
          { voices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, duration: "q" },
          { voices: { soprano: "Bb4", alto: "G4", tenor: "D3", bass: "G2" }, duration: "8" },
          { voices: { soprano: "C5", alto: "A4", tenor: "F3", bass: "C3" }, duration: "8" },
          { voices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, duration: "h" },
        ] },
        { endBarline: "final", events: [
          { voices: { soprano: "C5", alto: "A4", tenor: "F3", bass: "C3" }, duration: "q" },
          { voices: { soprano: "Bb4", alto: "G4", tenor: "E3", bass: "C3" }, duration: "8" },
          { voices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, duration: "h" },
        ] },
      ],
      harmonicEvents: [],
  ...
  createQuestion({
    ...
    context:
      "Continue from the fully supplied bar 17 and complete bars 18–19 in four parts. Use the printed Roman numerals, preserve the supplied soprano rhythm, and include at least two passing notes.",
    score: measuredScore({
      key: "F major → C major",
      keySignature: "C",
      layout: "satb",
      ...
      measures: [
        { events: [
          { voices: { soprano: "Bb4", alto: "G4", tenor: "C3", bass: "E2" }, questionVoices: { soprano: "Bb4", alto: "G4", tenor: "C3", bass: "E2" }, duration: "q" },
          { voices: { soprano: "C5", alto: "F4", tenor: "D3", bass: "F2" }, questionVoices: { soprano: "C5", alto: "F4", tenor: "D3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, questionVoices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "C5", alto: "F4", tenor: "A3", bass: "A2" }, questionVoices: { soprano: "C5", alto: "F4", tenor: "A3", bass: "A2" }, duration: "q" },
          { voices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, questionVoices: { soprano: "A4", alto: "F4", tenor: "C3", bass: "F2" }, duration: "8" },
          { voices: { soprano: "Bb4", alto: "E4", tenor: "C3", bass: "E2" }, questionVoices: { soprano: "Bb4", alto: "E4", tenor: "C3", bass: "E2" }, duration: "8" },
        ] },
        { events: [
          { voices: { soprano: "C5", alto: "F4", tenor: "A3", bass: "A2" }, questionVoices: { soprano: "C5" }, duration: "q" },
          { voices: { soprano: "D5", alto: "G4", tenor: "G3", bass: "B2" }, questionVoices: { soprano: "D5" }, duration: "q" },
          { voices: { soprano: "E5", alto: "G4", tenor: "C4", bass: "E3" }, questionVoices: { soprano: "E5" }, duration: "q" },
          { voices: { soprano: "G5", alto: "E4", tenor: "C4", bass: "C3" }, questionVoices: { soprano: "G5" }, duration: "q" },
        ] },
        { endBarline: "final", events: [
          { voices: { soprano: "C5", alto: "F4", tenor: "D3", bass: "G2" }, questionVoices: { soprano: "C5" }, duration: "q" },
          { voices: { soprano: "A4", alto: "F4", tenor: "D3", bass: "G2" }, questionVoices: { soprano: "A4" }, duration: "8" },
          { voices: { soprano: "B4", alto: "G4", tenor: "E3", bass: "G2" }, questionVoices: { soprano: "B4" }, duration: "8" },
          { voices: { soprano: "B4", alto: "F4", tenor: "D3", bass: "G2" }, questionVoices: { soprano: "B4" }, duration: "q" },
          { voices: { soprano: "C5", alto: "G4", tenor: "E3", bass: "C3" }, questionVoices: { soprano: "C5" }, duration: "q" },
        ] },
      ],
      harmonicEvents: [
        harmonicBox(1, 1, 0, "F: Vb", { questionLabel: "F: Vb", chordSymbol: "C7/E" }),
        harmonicBox(1, 2.5, 2, "I", { questionLabel: "I", chordSymbol: "F" }),
        harmonicBox(1, 3, 3, "Ib", { questionLabel: "Ib", chordSymbol: "F/A" }),
        harmonicBox(2, 1, 0, "F: Ib / C: IVb", { questionLabel: "C: IVb", chordSymbol: "F/A" }),
        harmonicBox(2, 2, 1, "Vb", { questionLabel: "Vb", chordSymbol: "G/B" }),
        harmonicBox(2, 3, 2, "Ib", { questionLabel: "Ib", chordSymbol: "C/E" }),
        harmonicBox(2, 4, 3, "I", { questionLabel: "I", chordSymbol: "C" }),
        harmonicBox(3, 1, 0, "V⁴", { questionLabel: "V⁴–³", chordSymbol: "G7sus4" }),
        harmonicBox(3, 3, 3, "V³", { chordSymbol: "G7" }),
        harmonicBox(3, 4, 4, "I", { questionLabel: "I", chordSymbol: "C" }),
      ],
      nonHarmonicNotes: [
        { measure: 3, event: 1, pitch: "A4", chordSymbol: "G7", type: "passing note" },
        { measure: 3, event: 2, pitch: "E3", chordSymbol: "G7", type: "passing note" },
      ],
    }),
  ...
  createQuestion({
    ...
    score: measuredScore({
      ...
      measures: [
        ...
        { events: [
          { treble: ["A3", "C4", "Eb4", "F#4"], bass: ["F2"], duration: "q" },
          { treble: ["C5"], bass: ["C3"], duration: "q" },
          { treble: [], trebleRest: true, bass: ["Eb3"], duration: "q" },
          { treble: ["A4"], bass: ["F2"], duration: "q" },
        ] },
        { events: [
      ...
      harmonicEvents: [
        ...
        harmonicBox(7, 1, 0, "F♯dim7/F", { chordSymbol: "F♯dim7/F" }),
    ...
    answer: [
      "<strong>Published analysis:</strong> C♯m(add9)–Dmaj7–Bm9–G♯dim/B–C♯7sus4–C♯7–F♯m–F♯dim7/F–F♯m/E–D♯m7(♭5)–Dmaj7. Credit alternatives when the score supports them.",
      "In bars 24–28, the bass descends F♯–F–E–D♯–D and contrasts with the earlier more static bass. One chord per bar slows and regularises the harmonic rhythm while the chromatic descent creates momentum and forward direction.",
    ],
  }),
  createQuestion({
